	...
	if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
		var e, t, o, i, n, r, s, a = {
			...
			l = {
				...
				embedStylesForCopyright: function () {
					...
					return e.innerHTML = ".tradingview-widget-copyright {font-size: 13px !important; line-height: 32px !important; text-align: center !important; vertical-align: middle !important; font-family: " + d + " !important; color: " + a["color-gull-gray"] + " !important;} .tradingview-widget-copyright .blue-text {color: " + a["color-brand"] + " !important;} .tradingview-widget-copyright a {text-decoration: none !important; color: " + a["color-gull-gray"] + " !important;} .tradingview-widget-copyright a:visited {color: " + a["color-gull-gray"] + " !important;} .tradingview-widget-copyright a:hover .blue-text {color: " + a["color-brand-hover"] + " !important;} .tradingview-widget-copyright a:active .blue-text {color: " + a["color-brand-active"] + " !important;} .tradingview-widget-copyright a:visited .blue-text {color: " + a["color-brand"] + " !important;}",
					e
				},
				embedStylesForFullHeight: function (e, t, o) {
					var i = t ? "calc(" + e + " - 32px)" : e,
						n = document.querySelector("#" + o);
					n.parentElement.style.height = i,
					n.style.height = "100%"
				},
				gId: function () {
				...
				css: function (e) {
					...
					i.type = "text/css",
					i.styleSheet ? i.styleSheet.cssText = e : (t = document.createTextNode(e), i.appendChild(t)),
					o.appendChild(i)
				},
				...
				QuotesProvider: function (e) {
					var t, o, i = l.gId(),
						...
						}, l.getHost(e) + "/embed-quotes-provider/?" + l.generateUtmForUrlParams(e));

					function r(e) {
						var i = e.symbol,
							n = e.success,
							r = e.error;
						i && n && r && (o.post(t.contentWindow, "resolveSymbol", {
							symbol: i
						}), n && o.on("success" + i, (function (e) {
							n(e)
						})), r && o.on("error" + i, (function (e) {
							r(e)
						})))
					}
					h('<iframe id="' + i + '" src="' + n + '" width="0" height="0" frameborder="0" allowTransparency="true" scrolling="no"></iframe>', e.container),
					t = document.getElementById(i),
					o = l.postMessageWrapper(t.contentWindow, i),
					l.bindEvent(t, "load", (function () {
						e.symbols.forEach(r)
					}))
				}
			};
		...
		l.IdeaWidget.prototype = {
			createWidget: function () {
				...
				this.postMessage.on("resize", (function (e) {
		...
		l.widget.prototype = {
			...
			generateUrl: function (e) {
				...
				function o(t, o) {
					return o = o || t,
					void 0 === e[t] ? "" : "&" + encodeURIComponent(o) + "=" + (e[t] ? "1" : "0")
				}
				function i(t, o, i) {
					return i = i || t,
					e[t] ? "&" + i + "=" + o : ""
		...
		l.chart.prototype = {
			create: function () {
				...
				l.onready((function () {
					var t = !1;
					if (document.querySelector && document.querySelector('a[href$="/v/' + o.options.chart + '/"]') && (t = !0), !t) for (var i = document.getElementsByTagName("a"), n = new RegExp("/v/" + o.options.chart + "/$"), r = new RegExp("/chart/([0-9a-zA-Z:+*-/()]+)/" + o.options.chart), s = 0; s < i.length; s++) if (n.test(i[s].href) || r.test(i[s].href)) {
						t = !0;
						break
					}
				...
				this.postMessage.on("toggleFullscreen", (function (t) {
		...
		l.postMessageWrapper = (o = {}, i = {}, n = {}, r = 0, s = 0, window.addEventListener && window.addEventListener("message", (function (e) {
			...
			t = e,
			{
				...
				get: function (e, t, i) {
					...
					o[a][s.id] = i,
					n[a].postMessage(JSON.stringify(s), "*")
				},
				post: function (e, t, o) {
					var i = {
						id: s++,
