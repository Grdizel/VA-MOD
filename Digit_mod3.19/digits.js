...
var colorBlueRed;
var tBlue = 0, tRed = 0;
var DigiLabelOdd5x5, DigiLabelEven5x5, mColorDigit5x5, уDigitLenta, yGraphBlueTr, yGraphRedTr, yGraphBlue, yGraphRed, BlueLength, RedLength, dBlue, dRed;
var DigitLenta = [], dgBlueTr = [], dgRedTr = [], dgGraphBlue = [], dgGraphRed = [], dgBluebin = [], dgRedbin = [];
...
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
		if (spot[i-1] < spot[i]){
			// yGraphBlue = parseFloat(tic[i-1])
			// yGraphRed = parseFloat(tic[i-1])
			if (digit[i]==9) {
				yGraphBlue = 1, 
				dBlue = '1'
				yGraphRed = -2,
...
//##############################################################################
		...
		// console.log(i, digit[i], yGraphBlue)
			...
			DigitLenta.push({//Blue
				...
				indexLabelFontColor: diglabfoncol,//fontCol,//fontCol цвет синих цифр
				indexLabelPlacement: "outstde",//lblPlace,
				color: didgitfontCol,//colorBlueRed,
				// markerBorderColor: "#ccc",
				})
			...
			dgBlueTr.push({//Blue
				...
				indexLabelFontWeight: "bold",
				indexLabelFontSize: 18,
				indexLabelFontColor: "#29abe2",//fontCol,//fontCol цвет синих цифр
				indexLabelPlacement: "inside",//lblPlace,
				color: "white",//colorBlueRed,
				// markerBorderColor: "#ccc",
				})
			dgRedTr.push({//Red
				x: i,
				...
				indexLabelFontWeight: "bold",
				indexLabelFontSize: 18,
				indexLabelFontColor: "#c03",//fontCol,//fontCol цвет красных цифр
				indexLabelPlacement: "inside",//lblPlace,
				color: "white",//colorBlueRed,
				// markerBorderColor: "#ccc",
				})
			...
			dps_red.push({
				...
				//indexLabelFontWeight: "bold",
				indexLabelFontSize: 18,
				indexLabelFontColor: colorBlueRed,//fontCol цвет красных цифр ни нижнем графике
				indexLabelPlacement: "inside",// lblPlace,
				color: "white",//colorBlueRed,
				markerBorderColor: "#ccc",
				});
			dps_blue.push({
				...
				indexLabelFontWeight: "bold",
				indexLabelFontSize: 18,
				indexLabelFontColor: colorBlueRed,//fontCol цвет синих цифр ни нижнем графике
				indexLabelPlacement: "inside",//lblPlace,
				color: "white",//colorBlueRed,
				markerBorderColor: "#ccc",
				});
