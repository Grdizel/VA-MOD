...
var dfcolorbBlue, dfcolorbRed, DigitLenta = [], dgBlueTr = [], dgRedTr = [],fiba0_spot = [], fiba100_spot = [], pat1 = [], pat2 = [], pat3 = [], pat4 = [], pat5 = [], pat6 = [], dgGraphBlue = [], dgGraphRed = [], dgBluebin = [], dgRedbin = [];
...
/* 		if (parseFloat(digit[i]) % 2 == 1) {
		...
		if (spot[i] > spot[i+1]) {
			...
			if(fiba100_spot.length > cnt+1) {
				while(fiba100_spot.length != cnt+1) {
					fiba100_spot.shift();
				}
			}
			if(fiba0_spot.length > cnt+1) {
				while(fiba0_spot.length != cnt+1) {
					fiba0_spot.shift();
				}
			}
...
chartPattern2 = new CanvasJS.Chart("chartPattern2", {
	theme: "light2",
    // subtitles: [{
    	// text: "Лента",		
    	// fontColor: "blue",
...
chartPattern3 = new CanvasJS.Chart("chartPattern3", {
	theme: "light2",
    // subtitles: [{
    	// text: "Лента",		
    	// fontColor: "blue",
...
chartPattern4 = new CanvasJS.Chart("chartPattern4", {
	theme: "light2",
    // subtitles: [{
    	// text: "Лента",		
    	// fontColor: "blue",
...
chartPattern6 = new CanvasJS.Chart("chartPattern6", {
	theme: "light2",
    // subtitles: [{
    	// text: "Лента",		
    	// fontColor: "blue",
